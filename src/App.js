...
const App = () => {
  return (
    <div className="bg-ligth vh-100 d-flex justify-content-center align-items-center">
      <form className="p-5 rounded-5 shadow border border-4 border-white form-container-lavender" >
        ...
        <div className="form-floating mt-3">
          <input type="password" className="form-control position-relative fw-semibold fs-5 border-0 shadow" placeholder="password" id="password" required />
          <label htmlFor="password" >Password</label>
          <div className="position-absolute pointer pwd-icon">
